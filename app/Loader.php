...
class Loader
{
     ...
     *
     * @var array<string, mixed> The actions registered with WordPress to fire when the plugin loads.
     */
    protected $actions;
     ...
     *
     * @var array<string, mixed> The filters registered with WordPress to fire when the plugin loads.
     */
    protected $filters;
